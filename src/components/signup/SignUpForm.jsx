	...
	return (
		<>
			<Box sx={{ minHeight: "80vh", margin: '0 40px' }}>
				...
				<CustomBox>
					<Box sx={{ flex: "1", }} mx={4}>
						<Title variant="h3" sx={{margin:"0px !important"}}>Sign Up</Title>
						<CustomBox >
							<Box sx={{ flex: '1' }}>
						...
						<Box sx={{ flex: '1' }} marginTop={2}>
							...
							<Button href='/profileform' variant="contained" size="small" sx={{
							...
							<Typography>Already have an account?<Link to='/signin'> <a>Sign in</a></Link></Typography>
						</Box>
					</Box>
					<Box>
						<Box component="img" src="./SignUp/signup.png" alt="" sx={{ maxWidth: "80%", marginBottom: "2.5rem", top: '20px' }} />
					</Box>
				</CustomBox>
			</Box>
		</>
