    ...
    >
      ...
      <Typography marginLeft="5%"
        ...
        <Stack className="Description">
          <Stack className="Text" style={{ paddingTop: "20px" }} >
          ...
          <Stack className="Text" style={{ paddingTop: "20px" }}>
            ...
            <p>HITACHI make SU3500 Scanning Electron Microscope (SEM). Energy Dispersive Spectroscopy (EDS) attachmentMATLAB/PSCAD/ETAP software/ANSYS/STAAD - PRO/AUTO – CAD Each department has inStackidual Labs.</p>
          </Stack>
          <Stack className="Text" style={{ paddingTop: "20px" }}>
