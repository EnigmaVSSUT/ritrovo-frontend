...
import {Link,Grid, Button, Card,CardContent,CardActions,CardActionArea,CardHeader,Avatar} from '@mui/material'
...
quora.getLayout=(app)=><DefaultLayout>{app}</DefaultLayout>;
